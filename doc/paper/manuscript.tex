...
\title{\bfseries\LARGE\singlespacing{Estimating \emph{Mycobacterium} tuberculosis transmission in a South African clinic: Spatiotemporal model}}
% author list
...
\begin{abstract}\normalfont
The risk of Mycobacterium tuberculosis (\emph{Mtb}) transmission can be high in crowded clinics. We developed a spatiotemporal model of airborne \emph{Mtb} transmission, based on the Wells-Riley equation. We collected environmental, clinical and person-tracking data in a South African clinic during COVID-19, when masks were compulsory and ventilation increased. We matched person tracks with clinical records to identify the spatiotemporal location of infectious TB patients. We modeled the concentration of infectious doses (quanta) and estimated the individual risk of infection. Over five days, video sensors detected 1,438 clinic attendees. CO$_2$ levels were low (median 431\,ppm, IQR 406\,ppm$-$458\,ppm); the quanta concentration was higher in the morning than in the afternoon, and highest in the waiting room. The estimated risk of infection per clinic attendee was 0.06\% (95\%-credible interval [CrI] 0.001\%$-$0.40\%). It increased with the number of close contacts with infectious patients and the time spent in the clinic, and was 1.28-fold (95\%-CrI 1.19$-$1.36) higher in scenarios without mask use and 1.74-fold (95\%-CrI 0.47$-$5.34) with pre-pandemic ventilation rates. Spatiotemporal modeling can identify high-risk areas and evaluate the impact of infection control measures in clinics.
