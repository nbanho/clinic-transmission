...
A novel spatiotemporal model to estimate \emph{Mycobacterium tuberculosis} transmission risks in crowded indoor settings using environmental, clinical, and patient movement data}}
