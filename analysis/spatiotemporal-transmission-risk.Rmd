...
comb_abs_pl <- grid.arrange(grid.arrange(highRiskPat_pl_abs, summary_tab_abs, ncol = 2, widths = 16 * c(0.7,.3)), qc_pl_abs, ncol = 1, heights = 25 / cm(1) * c(0.35, 0.65))
ggsave(plot = comb_abs_pl, filename = "../doc/Union/abstract/figure.png", width = 16 / cm(1), height = 25 / cm(1))
```
